"""Train Vanilla and CaT @2000 iterations for training budget fairness."""
import subprocess
import sys
import os
import time
...
SEEDS = [1, 2, 3, 4, 5, 6]
TASKS = ["safe_recovery_a1", "safe_recovery_a1_cat"]  # Vanilla and CaT
MAX_ITER = 2000  # Match Recovery PPO
...
for task in TASKS:
    for seed in SEEDS:
        ...
        print(f"\n{'='*60}")
        print(f"Training: {task} seed={seed}, iters={MAX_ITER}")
        print(f"{'='*60}")
...
print("\n\nAll 2000-iteration training complete!")
