"""Exp 4: A1 Rough Terrain Evaluation - Fixed Version"""
...
def evaluate_rough(task_name, load_run, num_eval_steps=10000, num_envs=128,
    ...
    # Rough terrain settings - use heightfield instead of trimesh for stability
    env_cfg.terrain.mesh_type = "heightfield"
    env_cfg.terrain.measure_heights = True
    env_cfg.terrain.curriculum = False
    env_cfg.terrain.selected = True
    # Use rough terrain type
    ...
    print("  Creating rough terrain env (heightfield)...")
    ...
    summary["meta/terrain_type"] = "rough_heightfield"
...
def run_rough_eval():
    print("=" * 70)
    print("EXP 4: A1 Rough Terrain Evaluation (Seeds 1-3) - FIXED")
    print("=" * 70)
